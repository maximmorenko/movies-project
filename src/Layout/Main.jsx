...
class Main extends Component {
    ...
    searchMovies = (str, type='all') => {
        ...
        // по этому добавляем еще одно выражение ${}, так как это выражение, то мы можемсделать еще одну проверку (тайп не равно 'all' и если это так, то мы добавим еще один амперсанд & (для скрепления гет параметров), добавим тайп и добавим то значение которое пришло снаружи) если 'all' то добавим пустую строку
        .then(response => response.json())
        .then(data => this.setState({movies: data.Search}))
    }
